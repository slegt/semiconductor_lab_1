...
in-plane solution maximizing the separation of the holes due to their negative charge. To
...
the close-packed direction of the oxygen hcp lattice by one oxygen-oxygen
...
material, with reference to the hcp oxygen sublattice and an aluminum interstitial
mesh, though these may in general be substituted by other anions/cations. \ac{algao}
also crystallizes in the corundum structure, where Al and Ga occupy the interstitial lattice
...
$z \in \mathbb{Z}$. It is possible to define the reciprocal lattice as the set $\{
\mathbf{B}\,\vert\, \exp(\mathrm{i}\mathbf{B}\cdot \mathbf{A})=1 \quad \forall \mathbf{A}
\in \text{span}(\mathbf{a}_{i}) \}$ \autocite{Ashcroft}. Analogously to real space,
...
$\mathbf{b}= h \mathbf{b_1}+ k \mathbf{b_2}+ l \mathbf{b_3}$. The entries of the tuple $(h\,k\,l
...
heteroepitaxially, as depicted in \cref{fig:film_growth}. If the lattice constants do
not differ too much, the film adopts the substrate's in-plane lattice constant
$a$. This is called pseudomorphic growth. A figure of merit to quantify the
