...
heteroepitaxially, depicted in \cref{fig:film_growth}. If the lattice constants do
...
by a dislocation vector $\mathbf{L}$. Most of the time, dislocations appear parallel
to the growth direction. By moving in a loop around the dislocation using the
local lattice coordinate system, the starting point is not reached. The
difference between start and end point is defined by the Burgers vector
...
energy. This agglomeration of dislocations results in grain boundaries which
separate monocrystalline regions of the thin film, called crystallites. They are
twisted by an angle $\delta$. By analog reasoning, an agglomeration of screw-type
