...
\DeclareAcronym{algao}{
    short = \ce{(Al_xGa_{1-x})_2O_3},
    long = aluminum gallium oxide
}
...
\begin{document}
    ...
    \input{chapters/3_theory_crystal.tex}
    \input{chapters/3_theory_diffraction.tex}
    \input{chapters/4_diffractometer.tex}
    \input{chapters/5_scanning_methods.tex}
