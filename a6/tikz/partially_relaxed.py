...
tikz.node(position=thin_film_width.midpoint(), text="$a_\mathrm{film}$", options="above")

tikz.compile(pdf_destination= file_path.parent / "assets" / "partially_relaxed.pdf")
