...
% TODO: declare acronyms used throughout this report, e.g.
% \DeclareAcronym{qe}{
%     short = QE,
%     long = quantum efficiency
% }
...
\begin{document}
    ...
    \input{chapters/3_theory_semiconductor.tex}
    \input{chapters/3_theory_radiometry.tex}
    \input{chapters/4_setup.tex}
    \input{chapters/5_methods.tex}
