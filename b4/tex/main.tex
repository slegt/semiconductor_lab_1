...
\begin{document}
    ...
    Claude (Anthropic) was used for spelling, grammar and language correction of this
    report. The scientific content, the data analysis and all conclusions are the
    authors' own work, and the authors take full responsibility for them.
